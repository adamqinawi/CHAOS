...
namespace CHAOS.Som
{
  public class CSpaceshipHlaObject : HlaObject
  {
    ...
    public CSpaceshipHlaObject(HlaObject _obj) : base(_obj)
    {
        ...
        //this.Location = ((CSpaceshipHlaObject)_obj).Location;
        //    this.ShipName = ((CSpaceshipHlaObject)_obj).ShipName;
        //    this.Callsign = ((CSpaceshipHlaObject)_obj).Callsign;
        //    this.Heading = ((CSpaceshipHlaObject)_obj).Heading;
        //    this.Class = ((CSpaceshipHlaObject)_obj).Class;
        //    this.CurrentPayloadWeight = ((CSpaceshipHlaObject)_obj).CurrentPayloadWeight;
    }
